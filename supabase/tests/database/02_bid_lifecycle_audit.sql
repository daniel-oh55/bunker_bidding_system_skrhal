...
select throws_ok($$select public.reassign_bid('00000000-0000-0000-0000-000000000211', (select id from bid_test_ids where name = 'main'), 6, '00000000-0000-0000-0000-000000000011')$$, '55000', 'Cancelled bids cannot be reassigned', 'cancelled bid cannot reassign');
