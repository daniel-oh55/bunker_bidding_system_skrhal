...
export function CreateBidForm({ buyers, organizations, disabled, onSubmit, inline = false, onClose }: { buyers: ActiveBuyer[]; organizations: TraderOrganization[]; disabled: boolean; onSubmit: (input: BidInput) => Promise<boolean>; inline?: boolean; onClose?: () => void }) {
