...
const buyer: AccessContext = { membership_id: '10000000-0000-4000-8000-000000000001', organization_id: '20000000-0000-4000-8000-000000000001', organization_kind: 'buyer', membership_role: 'buyer_operator' };
const trader: AccessContext = { membership_id: '10000000-0000-4000-8000-000000000002', organization_id: '20000000-0000-4000-8000-000000000002', organization_kind: 'trader', membership_role: 'trader' };
