...
try {
  ...
  { // update vs update: only the first revision wins.
    ...
    await beginAs(clients.a, ids.trader); await clients.a.query('select public.update_quote($1,$2,1,array[\'vlsfo\'],array[101]::numeric[],5)', [ids.traderMembership, x.quoteId]);
